    ...
    <PopupWithForm isOpen={props.isOpen} onSubmit={handleSubmit} onClose={props.onClose} name="edit-profile" title="Редактировать профиль" buttonTitle="Сохранить" children={
      <>
        <div className="popup__wrap">
          <input required id="username-input" defaultValue={name} onChange={handleNameChange} className="popup__input popup__username" name="name" placeholder="Имя" minLength="2" maxLength="40" />
          <span id="username-input-error" className="popup__error-text popup__error-text_username"></span>
        </div>
        <div className="popup__wrap">
          <input required id="bio-input" defaultValue={description} onChange={handleDescriptionChange} className="popup__input popup__bio" name="about" placeholder="О себе" minLength="2" maxLength="200" />
